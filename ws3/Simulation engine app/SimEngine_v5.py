...
if (want_recovery == True) & (type_recovery == 'Target sector(s)'):
    ...
    recovery_vec = network_model.recovery_impulse(general_stimulus=general_stimulus, type_stimulus = 'Spread stimulus')
...
if want_recovery:
    ...
    df_viz2['Selected intervention'] = np.sum((sol_rec * (GVA_vec / GVA_vec.sum()).values.T) * 100, axis = 1)
